...
public interface IngestorInterface {
    ...
    boolean addFileToBatch(AuthInfo authInfo, Schema schema, String batchId,
    ...
    void cancelBatch(AuthInfo authInfo, String batchId) throws ParameterException, InvalidCallException;
}
